...
${CR8} client-win2012-2 --image "https://www.googleapis.com/compute/v1/projects/windows-cloud/global/images/windows-server-2012-r2-dc-v20150721" --tags grr-clients --zone us-central1-a --machine-type n1-highmem-2
